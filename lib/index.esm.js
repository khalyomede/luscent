...
var updateDomTwo = function(context_1, state_1, newState_1, methods_1, elements_1) {
	...
	return __awaiter(void 0, __spreadArray([
		...
		var difference, computedDomUpdates, newElementsToRender, _a, elements_2, element, _b, domUpdates, elementsToRender, updates_1, _c, elements_3, element;
			...
			switch (_d.label) {
				...
				case 1:
					...
					newElementsToRender.forEach(function(partialState, element$1) {
						return updates_1.push(updateDomTwo(context, {}, partialState, methods, [element$1]));
					});
...
var start = function(parameters) {
	...
	var onStateChanged = parameters.onStateChanged;
	var context = { state };
	...
	return { updateState: function(state$1) {
		return __awaiter(void 0, void 0, void 0, function() {
			var changedState, newState;
			return __generator(this, function(_a) {
				switch (_a.label) {
					case 0:
						changedState = onStateChanged(__assign(__assign({}, context.state), state$1));
						newState = __assign(__assign(__assign({}, context.state), state$1), changedState);
						return [4, update_dom_two_default(context, context.state, newState, methods, [document])];
					case 1:
						_a.sent();
						return [2];
				}
